...
./configure --prefix=/data/apps/nginx --user=nginx --group=nginx --with-http_flv_module --with-http_sub_module --with-http_stub_status_module --with-http_gzip_static_module --with-http_realip_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_auth_request_module --with-http_random_index_module \
  ...
  --add-module=/data/apps/nginx/party_modules/ngx_http_geoip2_module-master \
  --add-module=/data/apps/nginx/party_modules/nginx-module-vts-0.1.18 \
  --add-module=/data/apps/nginx/party_modules/ngx_waf-8.0.3 \
  --with-debug 
